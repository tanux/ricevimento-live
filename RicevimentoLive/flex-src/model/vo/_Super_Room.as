...
public class _Super_Room extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("model.beans.Room") == null)
            {
                flash.net.registerClassAlias("model.beans.Room", cz);
            }
        }
        catch (e:Error)
        {
    ...
    [Bindable(event="propertyChange")]
    public function get roomsupervisor() : model.vo.Roomsupervisor
    {
        return _internal_roomsupervisor;
    }
    ...
    public function set roomsupervisor(value:model.vo.Roomsupervisor) : void
    {
        var oldValue:model.vo.Roomsupervisor = _internal_roomsupervisor;
        if (oldValue !== value)
        {
            _internal_roomsupervisor = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "roomsupervisor", oldValue, _internal_roomsupervisor));
        }
    }
